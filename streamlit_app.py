...
if st.button("Predict Price"):
    ...
    # Location cluster (placeholder if not used)
    ...
    input_data = np.array([[features[feat] for feat in ordered_feature_names]])

    # Prediction
predicted_price_log = model.predict(input_data)[0]
predicted_price = np.expm1(predicted_price_log)  # inverse of log1p
